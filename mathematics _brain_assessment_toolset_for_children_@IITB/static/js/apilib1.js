...
var apilib = {
	...
	/*
		Method:
			return the cookite from the browser by using cookie  name ( parameter name)
	*/
  ...
  /*
	Method
		Sends the game data captured during game play by making post request to the server i.e. url /app/submitdata
  */
  ...
  /*
	Method
		Sends the game data captured during game play by making post request to the server to send the score to lti server
		Firstly requests goes to our server than score is send to lti server
  */
...
//Random Functions
	...
	randIntpalindrome : function(params){
        var arr = [0,1,11,77,88,33,44,55,66,99,121,131,171,181,242,252,232,676,343,333,535,545,555,454,767,656,898,999,1001,1221,1331,3443,5445,
